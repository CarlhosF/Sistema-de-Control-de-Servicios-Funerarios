...
namespace CacheManager.CLS
{
    public class EmpleadosCache
    {
        ...
        public static DataTable Listar_Empleados()
        {
            DataTable Resultados = new DataTable();
            DataManager.CLS.OperacionBD Consultor = new DataManager.CLS.OperacionBD();
            String Consulta = @"SELECT a.idEmpleados as ID,a.nombres, a.apellidos,a.fechanacimiento as 'Fecha de Nacimiento',a.direccion,a.DUI,a.telefono,a.fechacontratacion as 'Fecha de Contratacion',b.nombre as 'sucursal',
                                c.nombre as 'Puesto: '
