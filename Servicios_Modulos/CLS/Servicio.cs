...
namespace Servicios_Modulos.CLS
{
    class Servicio
    {
        ...
        public string Valorcontado { get => _valorcontado; set => _valorcontado = value; }
        public string Valorcuota { get => _valorcuota; set => _valorcuota = value; }
        public string Descripcion { get => _descripcion; set => _descripcion = value; }
        public string Prima { get => _prima; set => _prima = value; }
